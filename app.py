...
.toggle-selected {
    ...
    color: white;
    box-shadow: 0 0 10px rgba(47, 70, 150, 0.6);
    border: 2px solid #2f4696;
}
.toggle-unselected {
...
if countries:
    ...
    if not results_df.empty:
        ...
        with col_user:
            ...
            fig_user = px.pie(case_totals_user,
        ...
        with col_bench:
            ...
            btn_style = lambda mode: "toggle-selected" if st.session_state.benchmark_mode == mode else "toggle-unselected"
            with col_btn1:
            ...
            fig_bench = px.pie(case_totals_bench,
                               values="Estimated Cases",
                               names="Case Type",
                               color="Case Type",
                               color_discrete_map=case_type_colors)
...
- **Fulfill your Duty of Care** by aligning with global standards like ISO 31030.  
        ...
        st.download_button(
            "📄 Download PDF Report",
            data=b"PDF_PLACEHOLDER",  # PDF generation logic placeholder
            file_name="InternationalSOS_RiskReport.pdf",
